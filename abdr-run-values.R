...
# data2011_raw <- retrosheet::getRetrosheet(year = 2011,
#                                           type = "play",
#                                           team = "DET")
# 
# data2011 <- data2011_raw

source("utils.R")

data2011_raw <- dbGetQuery(con, "select e.*, g.game_dt from retrosheet.events e left join retrosheet.games g on e.game_id = g.game_id where left(cast(game_dt as text), 4) = '2011' limit 10")
colnames(data2011) <- toupper(colnames(data2011))
